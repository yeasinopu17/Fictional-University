            ...
            <div class="one-third">
              ...
              ${
                results.programs.length
                  ? '<ul class="link-list min-list">'
                  : `<p>No programs matches that search. 
            ...
            <div class="one-third">
              ...
              ${
                results.campuses.length
                  ? '<ul class="link-list min-list">'
                  : `<p>No campuses matches that search.
              ...
              ${
                results.events.length
                  ? ""
                  : `<p>No events matches that search.
  ...
  class MyNotes {
    ...
    deleteNote(e) {
      ...
      $.ajax({
        ...
        success: (response) => {
          thisNote.slideUp();
          console.log("congrats delete ok");
    ...
    updateNote(e) {
      ...
      $.ajax({
        ...
        success: (response) => {
          this.makeNoteReadOnly(thisNote);
          console.log("congrats update ok");
          console.log(response);
        },
        error: (response) => {
          console.log("sorry");
    ...
    createNote(e) {
      ...
      $.ajax({
        ...
        success: (response) => {
          ...
          console.log("congrats created sucessfully");
          console.log(response);
        },
        error: (response) => {
          console.log("sorry");
